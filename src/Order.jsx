  ...
  return (
    <div className="w-dvw h-dvh bg-[#0F4C5C] flex flex-col justify-center items-center relative">
      <Link to="/K3Pizza_Eric/">
        ...
        <div className="w-[60rem] h-[40rem] bg-[#9A031E] flex flex-col items-center gap-3 py-5 flex-wrap rounded-xl relative">
            ...
            <div className="absolute bottom-2 right-[4rem] bg-white px-2 py-2 rounded-xl">
